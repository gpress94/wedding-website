                ...
                <form onSubmit={handleSubmit} className="flex flex-col items-center w-full max-w-[280px] mx-auto mt-8">
                  <div className="w-full relative mb-10">
                    <input
                      ...
                      className="w-full bg-transparent border-b border-theme-text/20 py-3 text-center font-sans tracking-[0.3em] text-theme-text focus:outline-none focus:border-theme-accent transition-all placeholder:text-theme-text/20 text-sm md:text-base"
                      autoFocus
                    />
